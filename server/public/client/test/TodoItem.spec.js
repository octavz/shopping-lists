...
import TodoTextInput from './ListTextInput'
...
describe('components', () => {
  describe('TodoItem', () => {
    ...
    it('button onClick should call deleteListItem', () => {
      const { output, props } = setup()
    ...
    it('ListTextInput onSave should call editTodo', () => {
      const { output, props } = setup(true)
      output.props.children.props.onSave('Use Redux')
      expect(props.editTodo).toBeCalledWith(0, 'Use Redux')
    })

    it('ListTextInput onSave should call deleteListItem if text is empty', () => {
      const { output, props } = setup(true)
      output.props.children.props.onSave('')
      expect(props.deleteTodo).toBeCalledWith(0)
    })

    it('ListTextInput onSave should exit component from edit state', () => {
